    ...
    std::string & error_msg )
{
    ...
    // Log the calculated pubkey_hash
    INFO_OUTPUT_CONSOLE("Calculated pubkey_hash: %s", pubkey_hash.c_str());
    ...
    std::string & hash_hex )
{
    ...
    INFO_OUTPUT_CONSOLE("===debug: key_mata: %s hash_hex: %s", key_mata.c_str(), hash_hex.c_str());
